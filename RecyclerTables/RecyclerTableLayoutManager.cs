...
namespace BToolbox.GUI.RecyclerTables
{
    ...
    public partial class RecyclerTableLayoutManager<TItem, TRowManager>
        where TItem : class
        where TRowManager : RecyclerTableLayoutRowManager<TItem>, new()
    {
        ...
        public RecyclerTableLayoutManager(Form containerForm, TableLayoutPanel table, int headerRows)
        {
